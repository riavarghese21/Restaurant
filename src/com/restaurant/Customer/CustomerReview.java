...
public class CustomerReview {
    ...
    private void submitReview() {
        ...
        try {
            ...
            String query = "INSERT INTO Reviews (customer_id, review_rating, review_title, review_description, review_date) VALUES (?, ?, ?, ?, ?)";
    ...
    private void loadReviews() {
        ...
        try {
            Connection connection = Database.getConnection();
            String query = "SELECT review_rating, review_title, review_description, review_date FROM Reviews";
            PreparedStatement statement = connection.prepareStatement(query);
